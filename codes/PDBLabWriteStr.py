...
# Selected Residues are those that distance between any atoms of res_1 and 'other_atoms' is less than 4.5 
...
def is_contact(res_1,other_atoms,cutoff):
	...
	for atom in res_1:
		...
		neighbors = ns.search(center, cutoff) # 4.5 for distance in angstrom
...
# base coordinates are the center of mass
def is_contact_cmass(res_1, other_atoms, cutoff):
    center = 0
    for atom in res_1:
...
# residue_map is dictionary that map Residue information obtained from 'get_atom_list' 
...
pdb1 = options.f1.split('/')[-1].split('.')[0]
pdb2 = options.f2.split('/')[-1].split('.')[0]

out_pdb1 = '{}/{}_{}-{}_{}.pdb'.format(out_folder, pdb1, chains_1, chains_2, chains_1)
out_pdb2 = '{}/{}_{}-{}_{}.pdb'.format(out_folder, pdb2, chains_1, chains_2, chains_2)

label_pdb1 = '{}/{}_{}-{}_{}_label.pdb'.format(out_folder, pdb1, chains_1, chains_2, chains_1)
label_pdb2 = '{}/{}_{}-{}_{}_label.pdb'.format(out_folder, pdb2, chains_1, chains_2, chains_2)

out_label1 = '{}/{}_{}-{}_{}_label.txt'.format(out_folder, pdb1, chains_1, chains_2, chains_1)
out_label2 = '{}/{}_{}-{}_{}_label.txt'.format(out_folder, pdb2, chains_1, chains_2, chains_2)

fPara = '{}/{}_{}-{}_{}_parameter.txt'.format(out_folder, pdb1, chains_1, pdb2, chains_2)
...
contacts_1 = get_contacts(input_1,all_atoms_2,'',cutoff)
contacts_2 = get_contacts(input_2,all_atoms_1,'',cutoff)
...
if (i_cutoff>0):
	...
	interface_1 = get_contacts(input_1,contact_map_1,'',i_cutoff)
	interface_2 = get_contacts(input_2,contact_map_2,'',i_cutoff)
...
save_contacts(str_1,chains_1,out_pdb1)
save_contacts(str_2,chains_2,out_pdb2)


#save the interface residues
save_residues(out_label1,interface_1,contacts_1)
save_residues(out_label2,interface_2,contacts_2)
...
save_constrained(out_pdb1, label_pdb1,interface_1)
save_constrained(out_pdb2, label_pdb2,interface_2)
