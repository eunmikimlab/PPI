...
code_path = '/home/jj140/project/ppi/codes/PDBChains.py'                # Path of a code to be run
HOME_DIR = '/home/jj140/scratch/ppi/batch/pfam'                              # Home directory where data want to be stored
...
#pdbFile = '/home/jj140/scratch/ppi/dbs/outputs/unique_human_pdb.csv'    # Unique PDB list
pdbFile = '/home/jj140/scratch/ppi/dbs/outputs/pfam_missing.csv'    # Unique PDB list 
#dbFile  = '/home/jj140/scratch/ppi/dbs/pdb_chain_enzyme.csv'            # DB to be searched
dbFile  = '/home/jj140/scratch/ppi/dbs/pdb_chain_pfam.tsv'            # DB to be searched
#dbFile  = '/home/jj140/scratch/ppi/dbs/pdb_chain_cath_uniprot.csv'            # DB to be searched
#dbFile  = '/home/jj140/scratch/ppi/dbs/pdb_chain_go.tsv'            # DB to be searched
#dbFile  = '/home/jj140/scratch/ppi/dbs/pdb_chain_scop_uniprot.tsv'            # DB to be searched
...
for step in Steps:
    ...
    exe_code = '{} {} -i {} -o {} -r {} -s {} -e {}'.format(python, code_path, pdbFile, out_result, dbFile, s_idx, e_idx)
